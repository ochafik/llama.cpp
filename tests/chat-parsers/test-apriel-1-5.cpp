...
void test_apriel_1_5_parser(chat_parser_impl impl)
{
    ...
    auto tmpls = read_templates("models/templates/unsloth-Apriel-1.5.jinja");
    auto metadata = json::parse(read_file("models/templates/ServiceNow-AI-Apriel-1.5-15b-Thinker.metadata.json"));
