...
// void gpt_sampler_init_grammar(llama_sampling_context * context) {
...
bool gpt_sampler_trigger_grammar(const struct llama_model * model, gpt_sampler * gsmpl, const std::string & trigger) {
    ...
    llama_sampler_accept_str(gsmpl->grmr, trigger.c_str());
                ...
                //     gpt_sampler_init_grammar(slot.ctx_sampling);
                //     // llama_sampler_init_grammar(model, params.grammar.c_str(), "root") : nullptr
