...
ggml_cgraph * clip_graph_qwen2vl::build() {
    ...
    // Patch-embed stem.
    //
    // Default path: single inp_raw fed into both Conv2D heads.
    // Video-pair path: two distinct input tensors, ref into _0 and cur
    // into _1. See VIDEO_CONV3D_CPP_DESIGN.md §3.3.
